export default function RegionalMap() {
  return <svg xmlns="http://www.w3.org/2000/svg" width="959" height="593">
  ...
  Place this code in the empty space below. */
    ...
    <g id="southwest" className="state">
      <path
        className="statepath"
        id="az"
    ...
    <g id="southeast" className="state">
      <path
        className="statepath"
        id="al"
    ...
    <g id="midatlantic" className="state">
      <path
        className="statepath"
        id="de"
    ...
    <g id="northeast" className="state">
      <path
        className="statepath"
        id="ct"
    ...
    <g id="northwest" className="state">
      <path
        className="statepath"
        id="id"
