export default function RegionalMap({selectedRegion, setSelectedRegion, handleClick}) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="959" height="593">
      ...
      <g
        id="midwest"
        className={
          selectedRegion === "midwest" ? "state-highlighted" : "state"
        }
        onMouseEnter={() => setSelectedRegion("midwest")}
      ...
      <g
        id="southwest"
        className={
          selectedRegion === "southwest" ? "state-highlighted" : "state"
        }
        onMouseEnter={() => setSelectedRegion("southwest")}
        onMouseLeave={() => setSelectedRegion("null")}
        onClick={handleClick}
      >
        <path
      ...
      <g
        id="south"
        className={
          selectedRegion === "south" ? "state-highlighted" : "state"
        }
        onMouseEnter={() => setSelectedRegion("south")}
        onMouseLeave={() => setSelectedRegion("null")}
        onClick={handleClick}
      >
        <path
      ...
      <g
        id="southeast"
        className={
          selectedRegion === "southeast" ? "state-highlighted" : "state"
        }
        onMouseEnter={() => setSelectedRegion("southeast")}
        onMouseLeave={() => setSelectedRegion("null")}
        onClick={handleClick}
      >
        <path
      ...
      <g
        id="midatlantic"
        className={
          selectedRegion === "midatlantic" ? "state-highlighted" : "state"
        }
        onMouseEnter={() => setSelectedRegion("midatlantic")}
        onMouseLeave={() => setSelectedRegion("null")}
        onClick={handleClick}
      >
        <path
      ...
      <g
        id="northeast"
        className={
          selectedRegion === "northeast" ? "state-highlighted" : "state"
        }
        onMouseEnter={() => setSelectedRegion("northeast")}
        onMouseLeave={() => setSelectedRegion("null")}
        onClick={handleClick}
      >
        <path
      ...
      <g
        id="northwest"
        className={
          selectedRegion === "northwest" ? "state-highlighted" : "state"
        }
        onMouseEnter={() => setSelectedRegion("northwest")}
        onMouseLeave={() => setSelectedRegion("null")}
        onClick={handleClick}
      >
        <path
      ...
      <g
        id="alaska"
        className={
          selectedRegion === "alaska" ? "state-highlighted" : "state"
        }
        onMouseEnter={() => setSelectedRegion("alaska")}
        onMouseLeave={() => setSelectedRegion("null")}
        onClick={handleClick}
      >
        <path
      ...
      <g
        id="hawaii"
        className={
          selectedRegion === "hawaii" ? "state-highlighted" : "state"
        }
        onMouseEnter={() => setSelectedRegion("hawaii")}
        onMouseLeave={() => setSelectedRegion("null")}
        onClick={handleClick}
      >
      ...
      <g className="statepath" fill="none" >
        <path
          className="al-fl"
